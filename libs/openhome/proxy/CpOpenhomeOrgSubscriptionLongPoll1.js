...
var CpProxyOpenhomeOrgSubscriptionLongPoll1 = function(udn, host){

	this.url = window.location.protocol + "//" + host + "/" + udn + "/openhome.org-SubscriptionLongPoll-1/control";  // upnp control url
